...
import com.temp.property.propertyReader;
 ...
 */
public class Config extends propertyReader {
    private static final InputStream INPUT_STREAM = Config.class.getResourceAsStream( "config.properties" );
