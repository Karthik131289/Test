...
import com.test.tp.download.ftp.FTPException;
import com.test.tp.download.ftp.FTPUtility;
import com.test.tp.download.ftp.SwingFileDownloadFTP;
...
public class DownloadTask extends SwingWorker<Void, Void> {
	...
	protected Void doInBackground() throws Exception {
        com.temp.FTPUtility util = new com.temp.FTPUtility(host, port, username, password);
		try {
            ...
            util.finish();
		} catch (com.temp.FTPException ex) {
